...
//         errors.mobileNumber = "Mobile number is required."; // Validate mobile number
//       if (!acceptTerms)
//         errors.terms = "You must accept the terms and conditions.";
//     }
//     if (!email.trim()) errors.email = "Email is required.";
...
//         email,
//         password,
//         mobileNumber, // Include mobile number in the request payload
//       });
//       await handleLogin(e);
//       closePopup();
//     } catch (err) {
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            {/* <input
              ...
              onChange={(e) => {
                ...
                if (name && e.target.value.length >= 4) {
