...
//   return (
//     <div className="bg-gradient-to-br from-blue-900 via-blue-400 to-blue-900 py-12 px-4">
//       {/* Title */}
...
//             <div
//               key={index}
//               className="flex flex-col items-center justify-center p-6 bg-gray-200 rounded-3xl animate-pulse"
//             >
...
//             {/* View All Exams Card */}
//             {/* <button
//               onClick={() => (window.location.href = `/all-exams`)}
//               className="group flex flex-col items-center justify-center bg-white p-6 rounded-3xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ease-in-out cursor-pointer"
//             >
//               <svg
//                 xmlns="http://www.w3.org/2000/svg"
//                 className="w-24 h-24 text-indigo-600 mb-4 group-hover:scale-110 transition-transform duration-300"
//                 fill="none"
//                 viewBox="0 0 24 24"
//                 stroke="currentColor"
//               >
