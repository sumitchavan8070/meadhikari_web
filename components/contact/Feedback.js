    ...
    <section className="bg-[#FFFFFF]">
      <div class="py-[100px] bg-white-900">
        <div class="container flex flex-col items-center justify-center w-full p-6 mx-auto text-center xl:px-0">
          ...
          <h2 class="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight text-black-800 lg:leading-tight lg:text-4xl  text-black">
            Here&lsquo;s what our customers said
          </h2>
          <p class="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl  text-gray-300">
        ...
        <div class="container p-6 mx-auto mb-10 xl:px-0">
          <div class="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
            <div class="lg:col-span-2 xl:col-auto">
              <div class="flex flex-col justify-between w-full h-full px-6 py-6 bg-gray-100  md:px-14 rounded-2xl md:py-14  bg-trueGray-800">
                <p class="text-2xl leading-normal  text-black-300">
                  Share a{" "}
                  <mark class="mx-1 text-indigo-800 bg-indigo-100 rounded-md ring-indigo-100 ring-4 ">
                    testimonial
                  </mark>{" "}
                ...
                <div class="flex items-center mt-8 space-x-3">
                  ...
                  <div>
                    ...
                    <div class="text-black-600  text-gray-600">
                      VP Sales at Google
                    </div>
                  </div>
                </div>
            ...
            <div class="">
              <div class="flex flex-col justify-between w-full h-full px-6 py-6 bg-gray-100 md:px-14 rounded-2xl md:py-14  bg-trueGray-800">
                <p class="text-2xl leading-normal  text-black-300">
                  ...
                  landing page template I&lsquo;ve seen. I would use this for
                  anything.
                </p>
                <div class="flex items-center mt-8 space-x-3">
                  <div class="flex-shrink-0 overflow-hidden rounded-full w-14 h-14">
