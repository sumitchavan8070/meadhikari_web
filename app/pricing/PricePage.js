...
// // //   return (
// // //     <section className="bg-gradient-to-b from-[#F5F9FF] to-[#E6F0FF] py-12 md:py-20 px-4 sm:px-6">
// // //       {/* Hero Section */}
...
// // //           {/* Coupon Section */}
// // //           <div className="max-w-md mx-auto mb-16 bg-white p-6 rounded-xl shadow-md border border-[#E6EFF9]">
// // //             <h3 className="text-xl font-semibold text-[#055AAB] mb-4 text-center">
// // //               Have a coupon code?
// // //             </h3>
...
// // import React, { useState, useEffect } from "react";
// // import axios from "axios";
// // import { FaCheckCircle, FaLock, FaTags } from "react-icons/fa";
// // import { BASE_URL, RAZORPAY_LIVE_KEY } from "@/utils/globalStrings";
// // import { useAuth } from "@/Context/AuthContext";
// // import LoginPopup from "@/components/LoginPopup";
// // import QuizCard from "../previous-year-paper/components/QuizCard";
...
// //                     <div
// //                       key={index}
// //                       className="p-3 border border-[#E6EFF9] rounded-lg hover:bg-[#F5F9FF] cursor-pointer transition-colors"
// //                       onClick={() => {
...
//     // Apply the coupon after a small delay to ensure state updates
//     setTimeout(() => {
//       applyCoupon();
//     }, 100);
//   };
...
//                   >
//                     <FaTimes className="mr-1" /> Remove coupon
//                   </button>
//                 </div>
//               )}
//               {error && <p className="mt-2 text-red-500">{error}</p>}
