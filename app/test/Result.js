...
const Result = ({ results, formatTime, questions, onClose }) => {
  ...
  //           let dataUrl;
  //           if (src.startsWith("https://file-hosting-app.vercel.app")) {
  ...
  //                 : ""
  //             }
  //             <h1 style="color: #1e293b; font-size: 28pt; margin-bottom: 10mm; text-align: center;">
  //               ${paperMeta.name || "Test Results"}
  //             </h1>
  //             <div class="performance-box">
  //               <h2 style="color: #2563eb; margin: 0; font-size: 36pt;">
  //                 ${Math.round(
  //                   (results.correctAnswers / results.totalQuestions) * 100
  //                 )}%
  //               </h2>
  //               <p style="margin: 4mm 0 0; color: #3b82f6; font-size: 14pt;">Performance Score</p>
  //             </div>
  ...
  //               <div class="content">
  //                 <div class="question">
  //                   <h3 style="color: #1e293b; margin-top: 0;">Question ${
  //                     i + 1
  //                   }</h3>
  ...
  //                   <div class="question-text" style="margin: 15px 0; font-size: 11pt;">
  //                     ${q.question}
  //                   </div>
  ...
  //                             : ""
  //                         }">
  //                           <strong>${String.fromCharCode(64 + opt)}.</strong>
  //                           ${option}
  //                         </div>
  //                       `;
  //                       })
  ...
  //                       ${String.fromCharCode(64 + correct)}
  //                     </div>
  //                     <div>
  ...
  //             <h2>Thank You!</h2>
  //             <p>For more practice tests and resources</p>
