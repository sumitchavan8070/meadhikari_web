    ...
    >
      ...
      <div className="flex flex-col justify-center items-start p-6 md:p-16 text-left w-full md:w-1/2 z-10">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-600">
          Prepare for Maharastra Police Bharti Exam
        </h1>

        <p className="text-lg sm:text-xl lg:text-xl mb-6 text-gray-700">
          Prepare for the Police Bharti Exam with the latest syllabus, previous
          year question papers, and mock tests. Practice with real Police bharti
          exam papers and boost your confidence. Stay ahead with expert study
      ...
      <div className="w-full md:w-1/2 h-auto relative">
        <img
          src="/images/police-bg.jpg" // Local image path
          alt="Police Bharti Exam Preparation - Syllabus, Previous Year Papers, Mock Tests"
