...
import OptimizedQuizCard from "./components/OptimizedQuizCard";
...
const TalathiLandingPage = ({ questionsData = [] }) => {
  // const { user } = useAuth();
  ...
  // Memoize enriched data to prevent unnecessary recalculations
  ...
  // Memoized handleStartTest to prevent unnecessary re-renders
...
export default TalathiLandingPage;
